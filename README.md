...
<head>
  ...
  <style>
    /* Make full height layout with flexbox */
    html, body {
      height: 100%;
      margin: 0;
    }
    body {
      ...
      background: #f9f9f9;
      color: #333;
      padding: 0; /* reset padding here because header has padding */
    ...
    main {
      flex: 1 0 auto; /* fill vertical space */
      max-width: 800px;
      margin: 1.5rem auto 2rem; /* add some margin top to separate from header */
      width: 100%;
      padding: 0 2rem;
      box-sizing: border-box;
    }
